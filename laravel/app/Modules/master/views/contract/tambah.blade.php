                ...
                <div class="row">                	
                    		...
                    		<legend>Tambah Kontrak</legend>
                                     ...
                                     <select id="select_vendor" name="vendor" data-placeholder="Pilih Vendor..." class="chosen-select" style="width:100%;" tabindex="2">
														...
														<div class="col-md-4 col-sm-6 col-xs-12">
															<div class="form-group form-group-sm" id="div_kategori">
																<input type="text" class="form-control reset" name="pekerjaan" required autocomplete="off">
															</div>
														</div>
														...
														<div class="col-md-4 col-sm-6 col-xs-12">
															<div class="form-group form-group-sm" id="div_kategori">
																<input type="text" class="form-control reset" name="no_kontrak" required autocomplete="off">
															</div>
														</div>
														...
														<div class="col-md-4 col-sm-6 col-xs-12">
															<div class="form-group form-group-sm" id="div_kategori">
																<input id="tgl" type="text" class="form-control reset" name="tanggal_kontrak" required autocomplete="off">
															</div>
														</div>
														...
														<div class="col-md-4 col-sm-6 col-xs-12">
															<div class="form-group form-group-sm" id="div_kategori">
																<input type="text" class="form-control reset" name="durasi_kontrak" required autocomplete="off">
															</div>
														</div>


<table class="table" width="100%">
	<td><input placeholder="Nama Barang" id="dt_nama" style="width:100%" type="" name="dt_nama" class="form-control reset1"></td>
	<td><input placeholder="Jumlah" id="dt_jumlah" style="width:100%" type="number" name="dt_jumlah"class="form-control reset1"></td>
	<td><input placeholder="Satuan" id="dt_satuan" style="width:100%" type="" name="dt_satuan" class="form-control reset1"></td>
	<td>
...
$.getJSON("{{route('select_vendor')}}", function(json){
    ...
    $select_elem.empty();
    $.each(json, function (idx, obj) {
    	$select_elem.append('<option>--Pilih Vendor--</option>');
    	for(x = 0;x < obj.length;x++) {  
