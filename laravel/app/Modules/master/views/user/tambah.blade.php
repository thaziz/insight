...
<input type="text" class="form-control reset" name="nama" required autocomplete="off">
															</div>
														</div>
														...
														<div class="col-md-4 col-sm-6 col-xs-12">
															<div class="form-group form-group-sm" id="div_kategori">
																<input type="text" class="form-control reset" name="nip" required autocomplete="off">
															</div>
														</div>
														...
														<div class="col-md-4 col-sm-6 col-xs-12">
															<div class="form-group form-group-sm">
																<input type="text" class="form-control reset" name="bidang" required autocomplete="off">
															</div>
														</div>
														...
														<div class="col-md-4 col-sm-6 col-xs-12">
															<div class="form-group form-group-sm">
																<input type="text" class="form-control reset" name="email" required autocomplete="off">
															</div>
														</div>
														...
														<div class="col-md-4 col-sm-6 col-xs-12">
															<div class="form-group form-group-sm">
																<input type="number" class="form-control reset" name="hp" required autocomplete="off">
															</div>
														</div>
													...
													<div class="col-md-4 col-sm-6 col-xs-12">
														...
														<div class="col-md-4 col-sm-6 col-xs-12">
															<div class="form-group form-group-sm">
																<input type="password" class="form-control reset" name="password" required autocomplete="off">
															</div>
														</div>
