		...
		function simpan(){
			if (validation()) {
				...
				$.ajax({
					...
					dataType: 'json',
					url : baseUrl + '/master-group/simpan',
...
function myFunction() {
  var copyText = document.getElementById("group");
  copyText.select();
